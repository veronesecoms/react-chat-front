...
const server = setupServer(
  rest.put("http://localhost:3100/users/emailRecoveryPassword/renatop@hotmail.com.br", (req, res, ctx) => {
    return res(
      ctx.json({ message: 'Foi enviado um e-mail com as instruções para recuperação da senha' }),
      ctx.status(200)
    )
  }),
